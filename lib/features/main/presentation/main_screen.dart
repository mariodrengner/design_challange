...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
        children: [
          Image.asset(AppAssets.bgMain, alignment: Alignment.topCenter, height: MediaQuery.of(context).size.height, fit: BoxFit.cover),
          SafeArea(
            child: Column(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GlassChip(
                        ...
                        leading: index == 0
                            ? SvgPicture.asset(AppAssets.food, colorFilter: selected ? const ColorFilter.mode(Color.fromRGBO(48, 44, 35, 1), BlendMode.srcIn) : const ColorFilter.mode(Colors.white70, BlendMode.srcIn))
                            : null,
                        trailing: index == 0
                  ...
                  child: Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('Angi’s Yummy Burger ', style: theme.textTheme.headlineLarge),
                                    SizedBox(height: 8),
                                    Padding(
                                      padding: EdgeInsetsGeometry.only(right: 180),
                                      child: Text('Delish vegan burger that tastes like heaven', style: theme.textTheme.bodyMedium!.copyWith(color: AppColors.textGrey) ),
                                    ),
                                    SizedBox(height: 15),
                                    PriceDisplay(
                                      price: 13.99,
                                    ...
                                    GradientButton(
                                      ...
                                      width: 110,
                                      height: 40,
                                      child: Text('Add to order', style: theme.textTheme.labelLarge),
                                    ),
                        ...
                        Positioned(
                          bottom: -20, right: 0,
                          child: Image.asset(AppAssets.burger, width: 225, height: 225)
                        ),
                      ],
                    ),
                  ),
